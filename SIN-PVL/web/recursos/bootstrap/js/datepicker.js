...
function getMonthYearString(dt) {
  return ['Enero','Febrero','Marso','Abril','Mayo','Junio','Julio',
          'Agosto','Septiempre','Octubre','Noviembre','Dicienbre'][dt.getMonth()] +
         ' ' + dt.getFullYear();
}
...
function createCalendar(div, month) {
  ...
  daysRow.insertCell(-1).innerHTML="Mier";
  daysRow.insertCell(-1).innerHTML="Jue";
  daysRow.insertCell(-1).innerHTML="Vier";
  daysRow.insertCell(-1).innerHTML="sab";
  daysRow.insertCell(-1).innerHTML="Dom";
