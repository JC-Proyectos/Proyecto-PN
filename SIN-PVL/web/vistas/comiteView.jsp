                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">NOM.COMITE</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="NOMBRE COMITE">
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label  class="col-sm-2 control-label">REPRE. COM</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="REPRESENTANTE DEL COMITE">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label  class="col-sm-2 control-label">CORR. ELECTR</label>
                                    <div class="col-sm-10">
